 ...
 * on 2015-04-06 at 17:22:55 UTC 
 * Modify at your own risk.
 */

package com.mobile.dev.quantity.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "sayGoodbye".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SayGoodbye#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public SayGoodbye sayGoodbye(java.lang.String name) throws java.io.IOException {
    SayGoodbye result = new SayGoodbye(name);
    initialize(result);
    return result;
  }

  public class SayGoodbye extends MyApiRequest<com.mobile.dev.quantity.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "sayGoodbye/{name}";

    /**
     * Create a request for the method "sayGoodbye".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SayGoodbye#execute()} method to invoke the remote operation. <p>
     * {@link
     * SayGoodbye#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param name
     * @since 1.13
     */
    protected SayGoodbye(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.mobile.dev.quantity.backend.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public SayGoodbye setAlt(java.lang.String alt) {
      return (SayGoodbye) super.setAlt(alt);
    }

    @Override
    public SayGoodbye setFields(java.lang.String fields) {
      return (SayGoodbye) super.setFields(fields);
    }

    @Override
    public SayGoodbye setKey(java.lang.String key) {
      return (SayGoodbye) super.setKey(key);
    }

    @Override
    public SayGoodbye setOauthToken(java.lang.String oauthToken) {
      return (SayGoodbye) super.setOauthToken(oauthToken);
    }

    @Override
    public SayGoodbye setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SayGoodbye) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SayGoodbye setQuotaUser(java.lang.String quotaUser) {
      return (SayGoodbye) super.setQuotaUser(quotaUser);
    }

    @Override
    public SayGoodbye setUserIp(java.lang.String userIp) {
      return (SayGoodbye) super.setUserIp(userIp);
    }
    ...
    public SayGoodbye setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public SayGoodbye set(String parameterName, Object value) {
      return (SayGoodbye) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.mobile.dev.quantity.backend.myApi.model.MyBean> {
